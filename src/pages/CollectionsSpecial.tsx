...
const CollectionsSpecial = () => (
  <div className="min-h-screen bg-clay py-20">
    <div className="max-w-5xl mx-auto px-4 text-center">
      <h1 className="font-playfair text-5xl font-bold text-primary mb-6">Special Blends Collection</h1>
      <p className="text-lg text-earthy-brown mb-8">Unique, limited-edition, and seasonal blends. Experience something extraordinary.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8">
        {[1,2,3,4,5,6].map(i => (
          <div key={i} className="bg-white rounded-2xl premium-shadow p-6 animate-fade-in-scale">
            ...
            <h3 className="font-playfair text-xl font-bold text-primary mb-2">Special Blend #{i}</h3>
            <p className="text-sm text-earthy-brown mb-2">Limited, Unique</p>
